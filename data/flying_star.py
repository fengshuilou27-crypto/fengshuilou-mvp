...
FLYING_STAR_TABLE = {
    ...
    "七運": {
        ...
        "酉山卯向": {
            ...
            "mountain_stars": {
                ...
                "southeast": 7, "south": 6, "southwest": 1,
                "west": 8, "northwest": 3, "center": 5
            },
            "facing_stars": {
                "north": 4, "northeast": 9, "east": 2,
                "southeast": 7, "south": 6, "southwest": 1,
            ...
            "auspicious_combos": [],
            "inauspicious_combos": [
                {"direction": "west", "stars": "88", "desc": "正西八白重臨，運過即衰"}
            ],
            "annual_overlay": {
                2026: {"south": "二黑+五黃(大凶)", "center": "一白+九紫(中吉)"}
            },
            "base_score": 8,
            "confidence": 0.7,
            "note": "七運上山下水，損財傷丁。⚠️ MVP 簡化排盤，需專業確認"
        },
        ...
        "艮山坤向": {
            "pan_type": "雙星會向",
            "mountain_stars": {
                "north": 6, "northeast": 7, "east": 8,
                "southeast": 9, "south": 1, "southwest": 2,
                "west": 3, "northwest": 4, "center": 5
            },
            "facing_stars": {
                "north": 6, "northeast": 7, "east": 8,
                "southeast": 9, "south": 1, "southwest": 2,
            ...
            "auspicious_combos": [
                {"direction": "southwest", "stars": "22", "desc": "西南二黑會合，旺財之局"}
            ],
            "inauspicious_combos": [
                {"direction": "center", "stars": "55", "desc": "中宮五黃重臨，病符纏身"}
            ],
            "annual_overlay": {
                2026: {"south": "二黑+五黃(大凶)", "center": "一白+九紫(中吉)"}
            },
        ...
        # ---- 坤山艮向 (坐西南向东北) — MVP简化排盘，基于艮山坤向近似 ⚠️ ----
        "坤山艮向": {
            "pan_type": "上山下水",
            "mountain_stars": {
                "north": 5, "northeast": 6, "east": 7,
                "southeast": 8, "south": 9, "southwest": 1,
                "west": 2, "northwest": 3, "center": 4
            },
            "facing_stars": {
                "north": 5, "northeast": 6, "east": 7,
                "southeast": 8, "south": 9, "southwest": 1,
            ...
            "auspicious_combos": [],
            "inauspicious_combos": [
                {"direction": "northeast", "stars": "66", "desc": "東北六白重臨，運過即衰"}
            ],
            "annual_overlay": {
                2026: {"south": "二黑+五黃(大凶)", "center": "一白+九紫(中吉)"}
            },
            "base_score": 10,
            "confidence": 0.6,
            "note": "七運坤山艮向（坐西南向东北），MVP简化排盘，base_score 10/40。⚠️ 需专业师傅确认"
        },
        ...
        "巽山乾向": {
            "pan_type": "上山下水",
            "mountain_stars": {
                "north": 1, "northeast": 6, "east": 8,
                "southeast": 4, "south": 2, "southwest": 9,
                "west": 7, "northwest": 5, "center": 3
            },
            "facing_stars": {
                "north": 1, "northeast": 6, "east": 8,
                "southeast": 4, "south": 2, "southwest": 9,
            ...
            "auspicious_combos": [],
            "inauspicious_combos": [
                {"direction": "northwest", "stars": "55", "desc": "西北五黃重臨，損丁傷財"}
            ],
            "annual_overlay": {
                2026: {"south": "二黑+五黃(大凶)", "center": "一白+九紫(中吉)"}
            },
    ...
    "八運": {
        ...
        "酉山卯向": {
            "pan_type": "雙星會向",
            "mountain_stars": {
                "north": 5, "northeast": 4, "east": 3,
                "southeast": 2, "south": 1, "southwest": 9,
                "west": 8, "northwest": 7, "center": 6
            },
            "facing_stars": {
                "north": 5, "northeast": 4, "east": 3,
                "southeast": 2, "south": 1, "southwest": 9,
            ...
            "auspicious_combos": [
                {"direction": "east", "stars": "33", "desc": "正東雙星會向，旺財之局"}
            ],
            "inauspicious_combos": [
                {"direction": "center", "stars": "66", "desc": "中宮六白過旺，官非損丁"}
            ],
            "annual_overlay": {
                2026: {"south": "二黑+五黃(大凶)", "center": "一白+九紫(中吉)"}
            },
        ...
        "艮山坤向": {
            ...
            "base_score": 35,
            "confidence": 0.9,
            "note": "八運到山到向，丁財兩得。旺山旺向格局，八運最旺坐向之一"
        },
        ...
        "坤山艮向": {
            ...
            "auspicious_combos": [
                {"direction": "northeast", "stars": "88", "desc": "東北八白雙星會聚，旺財之局"}
            ],
            "inauspicious_combos": [
                {"direction": "west", "stars": "44", "desc": "正西四綠重臨，文昌無力"}
            ],
            "annual_overlay": {
                2026: {"south": "二黑+五黃(大凶)", "center": "一白+九紫(中吉)"}
            },
            "base_score": 25,
            "confidence": 0.7,
            "note": "八運坤山艮向（坐西南向东北），MVP简化排盘，base_score 25/40。⚠️ 需专业师傅确认"
        },
        ...
        "巽山乾向": {
            "pan_type": "上山下水",
            "mountain_stars": {
                "north": 2, "northeast": 7, "east": 9,
                "southeast": 5, "south": 3, "southwest": 1,
                "west": 6, "northwest": 4, "center": 8
            },
            "facing_stars": {
                "north": 2, "northeast": 7, "east": 9,
                "southeast": 5, "south": 3, "southwest": 1,
            ...
            "auspicious_combos": [],
            "inauspicious_combos": [
                {"direction": "northwest", "stars": "44", "desc": "西北四綠重臨，文昌受阻"},
                {"direction": "center", "stars": "88", "desc": "中宮八白過旺，運過即衰"}
            ],
            "annual_overlay": {
                2026: {"south": "二黑+五黃(大凶)", "center": "一白+九紫(中吉)"}
            },
            "base_score": 8,
            "confidence": 0.7,
            "note": "八運上山下水，損財傷丁。⚠️ MVP 簡化排盤，需專業確認"
        },
    },
    ...
    "九運": {
        ...
        "酉山卯向": {
            "pan_type": "到山到向",
            "mountain_stars": {
                "north": 1, "northeast": 2, "east": 3,
                "southeast": 4, "south": 9, "southwest": 8,
                "west": 7, "northwest": 6, "center": 5
            },
            "facing_stars": {
                "north": 1, "northeast": 2, "east": 3,
            ...
            "auspicious_combos": [
                {"direction": "east", "stars": "33", "desc": "正東雙星會向，旺丁旺財"},
                {"direction": "south", "stars": "99", "desc": "正南九紫連珠，喜慶連連"}
            ],
            "inauspicious_combos": [
                {"direction": "west", "stars": "77", "desc": "正西七赤重臨，口舌官非"}
            ],
            "annual_overlay": {
                2026: {"south": "二黑+五黃(大凶)", "center": "一白+九紫(中吉)"}
            },
        ...
        "艮山坤向": {
            ...
            "auspicious_combos": [
                {"direction": "southwest", "stars": "22", "desc": "西南雙星會向，旺財之局"}
            ],
            "inauspicious_combos": [
                {"direction": "center", "stars": "55", "desc": "中宮五黃重臨，病符纏身"}
            ],
            ...
            "base_score": 15,
            "confidence": 0.7,
            "note": "九運雙星會向，旺財不旺丁。⚠️ MVP 簡化排盤，需專業確認"
        },
        ...
        "坤山艮向": {
            "pan_type": "上山下水",
            "mountain_stars": {
                "north": 4, "northeast": 5, "east": 6,
                "southeast": 7, "south": 8, "southwest": 9,
                "west": 1, "northwest": 2, "center": 3
            },
            "facing_stars": {
                "north": 4, "northeast": 5, "east": 6,
                "southeast": 7, "south": 8, "southwest": 9,
            ...
            "auspicious_combos": [],
            "inauspicious_combos": [
                {"direction": "northeast", "stars": "55", "desc": "東北五黃重臨，煞氣當令"}
            ],
            "annual_overlay": {
                2026: {"south": "二黑+五黃(大凶)", "center": "一白+九紫(中吉)"}
            },
            "base_score": 12,
            "confidence": 0.6,
            "note": "九運坤山艮向（坐西南向东北），MVP简化排盘，base_score 12/40。⚠️ 需专业师傅确认"
        },
        ...
        "巽山乾向": {
            ...
            "auspicious_combos": [],
            "inauspicious_combos": [
                {"direction": "northwest", "stars": "99", "desc": "西北九紫重臨，火煞過旺"},
                {"direction": "center", "stars": "44", "desc": "中宮四綠過旺，文昌受阻"}
            ],
            "annual_overlay": {
                2026: {"south": "二黑+五黃(大凶)", "center": "一白+九紫(中吉)"}
            },
            "base_score": 12,
            "confidence": 0.7,
            "note": "九運上山下水，損財傷丁。⚠️ MVP 簡化排盤，需專業確認"
        },
    }
}
